...
JSON_RESULT_FILE = "gwo_best_result.json" # ficheiro para ler os hiperparametros
FINAL_EPOCHS = 100
FINAL_PATIENCE = 10
MODEL_SAVE_PATH = "final_model_gwo.keras" # ficheiro para salvar o melhor modelo final treinado
HISTORY_SAVE_PATH = "history_gwo.pkl" # ficheiro para salvar o historico do treino para fazer plot dos graficos de loss e accuracy
