...
# =====================================================================
#  CARREGAR EfficientNetB0 PRÉ-TREINADA (ImageNet)
# =====================================================================
...
# =====================================================================
model.save("EfficientNetB0_baseline.keras")
print("\nModelo guardado como EfficientNetB0_baseline.keras")
...
"""
import pickle
with open("history_EfficientNetB0_baseline.pkl", "wb") as f:
